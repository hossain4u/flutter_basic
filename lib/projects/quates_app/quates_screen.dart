...
class QuatesScreen extends StatelessWidget {
  ...
  final List<Map<String, dynamic>> quotes = const [
    ...
    },
    {
      "id": 6,
      "quote":
          "He who is not merciful to others, will not be mercifully dealt with.",
      "author": "Prophet Muhammad (ﷺ)",
    },
    {
      "id": 7,
    ...
    },
    {
      "id": 12,
      "quote":
          "Satan promises you poverty and enjoins upon you immorality, but Allah promises you forgiveness and bounty from Him.",
      "author": "Quran (2:268)",
    },
    {
      "id": 13,
    ...
    },
    {
      "id": 18,
      "quote":
          "A true Muslim is the one from whose tongue and hands the others are safe.",
      "author": "Prophet Muhammad (ﷺ)",
    },
    {
      "id": 19,
    ...
    },
    {
      "id": 20,
      "quote":
          "No man has ever drunk a better drink than the drink of patience.",
      "author": "Prophet Muhammad (ﷺ)",
    },
    {
      "id": 21,
    ...
    },
    {
      "id": 28,
      "quote":
          "The dunya (this world) is a prison for the believer and a paradise for the disbeliever.",
      "author": "Prophet Muhammad (ﷺ)",
    },
    {
      "id": 29,
    ...
    },
    {
      "id": 33,
      "quote":
          "Live your life like you are going to die tomorrow, and live for the Hereafter as if you are going to live forever.",
      "author": "Caliph Ali ibn Abi Talib",
    },
    {
      "id": 34,
      "quote":
          "Beware of envy, for it eats up good deeds just as fire eats up wood.",
      "author": "Prophet Muhammad (ﷺ)",
    },
    {
      "id": 35,
    ...
    },
    {
      "id": 38,
      "quote":
          "And when the foolish address them [with insults], they say [words of] peace.",
      "author": "Quran (25:63)",
    },
    {
      "id": 39,
    ...
    },
    {
      "id": 42,
      "quote":
          "And those who have believed and done righteous deeds - We will surely remove from them their misdeeds and will surely recompense them with the best of what they used to do.",
      "author": "Quran (29:7)",
    },
    {
      "id": 43,
      "quote":
          "The one who is merciful to others will be shown mercy by the Most Merciful.",
      "author": "Prophet Muhammad (ﷺ)",
    },
    {
      "id": 44,
    ...
    },
    {
      "id": 45,
      "quote":
          "The most complete in faith amongst believers is he who is the best in character.",
      "author": "Prophet Muhammad (ﷺ)",
    },
    {
      "id": 46,
    ...
    },
    {
      "id": 50,
      "quote":
          "Tawakkul (trust in Allah) is not to abandon effort, but to trust that Allah will make your effort fruitful.",
            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                    image: NetworkImage('https://images.unsplash.com/photo-1589186222872-418c38954ca3?q=80&w=686&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'),
                fit: BoxFit.cover,
                  opacity: 0.15,
                )
              ),
